...
$this->title = 'Data Master Konsumen';
...
<div class="konsumen-index">
    ...
    <p>
        <?= Html::a('Tambah Data Konsumen', ['create'], ['class' => 'btn btn-success']) ?>
    </p>

    <div class="box">
    <div class="box-header">
        <b><center> <h3 class="box-title">Data Master Konsumen</h3></center></b>
    </div>
...
<div class="box-body">
    <table id="example1" class="table table-bordered table-striped">
        ...
        ?>
           ...
           <td> <center>
                <?= Html::a('<i class="fa fa-search"></i>', ['/konsumen/view', 'id' =>$db['id_konsumen']], ['class' => 'btn btn-warning btn-xs']) ?>
                <?= Html::a('<i class="fa fa-pencil"></i>', ['/konsumen/update', 'id' =>$db['id_konsumen']], ['class' => 'btn btn-info btn-xs']) ?>
                <?= Html::a('<i class="fa fa-trash"></i>', ['/konsumen/delete', 'id' =>$db['id_konsumen']], [
